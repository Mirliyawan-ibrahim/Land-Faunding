<div class="container mt-5 mb-5">
    ...
    <div class="row justify-content-between mt-5 mb-5">
        <div class="col-4-md">
            ...
            <button type="button" class="btn btn-outline-success btn-lg">Monitoring Sisa Alokasi</button>
        </div>
...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header">
        <div class="card-title ml-5 mt-5">
            <h3 class="card-label mb-5">Permohonan Status : <span class="text-success font-weight-bolder">Sudah Diapprove</span></h3>
        </div>
        ...
        <div class="container">
            ...
            <div class="alert alert-custom alert-notice alert-light-warning fade show text-right" role="alert">
                ...
                <div class="alert-close">
                    <a href="#" class="btn btn-outline-success btn-lg font-weight-bold btn-pill mr-5">LIHAT</a>
    ...
    <div class="card-body">
        <div class="container mt-5 mb-5">
            ...
            <div class="row justify-content-between">
                <div class="mt-5">
                    <button type="button" class="btn btn-outline-success btn-lg mr-5">Sedang Diproses</button>
                    <button type="button" class="btn btn-outline-success btn-lg mr-5">Diterima</button>
                    <button type="button" class="btn btn-outline-success btn-lg">Tertolak</button>
                </div>
                <div>
                    <br><br>
            ...
            <table class="table table-bordered table-hover table-fixed">
                ...
                <tbody>
                    <tr>
                        ...
                        <td> <button href="#" class="btn btn-success font-weight-bold btn-pill btn-md">Lihat Detail</td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
                        <td>Non Bidang</td>
