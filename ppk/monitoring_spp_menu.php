    ...
    <div class="card-body">
        ...
        <div class="container">
            ...
            <div class="text-center text-success font-weight-bold mt-5">
                <p>Softcopy dokumen anda sudah di terima dan sedang kami cek</p>
            </div>
            <div class="alert alert-custom alert-light-warning fade show text-center" role="alert">
                <div class="alert-text text-success font-weight-bold">Silahkan mengirimkan hardcopy Anda
                    ...
                    <a href="#" class="btn btn-outline-success mt-2">
                        <i class="far fa-file-alt mr-2"></i><span class="font-weight-boldest">Download Guidline PDF</span>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="card-body">
        <div class="container mt-5 mb-5">
            ...
            <div class="row justify-content-between">
                <div class="mt-5">
                    <button type="button" class="btn btn-outline-primary btn-lg mr-5">Sedang Diproses</button>
                    <button type="button" class="btn btn-outline-success btn-lg mr-5">Diterima</button>
                    <button type="button" class="btn btn-outline-danger btn-lg">Tertolak</button>
                </div>
                <div>
                    <br><br>
            ...
            <table class="table table-bordered table-hover table-fixed text-center">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>10/11/20</td>
                        <td>10/12/20</td>
                        <td> <button href="#" class="btn btn-lman font-weight-bold btn-md font-weight-boldest">SK No. 124</td>
                    </tr>
                    <tr>
                        <th scope="row">2</th>
                        <td>Kebun</td>
